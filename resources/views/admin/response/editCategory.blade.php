...
<form class="profile-form pad-top-20 pad-bot-20" id="resetPasswordForm" action="{{route('admin.settings.catagories.update')}}" method="post" enctype="multipart/form-data">
    @csrf
